...
abstract contract ElasticERC20 is Context, PricableAsset, IERC20Metadata {
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        _transferElastic(_msgSender(), to, _convertToNominalWithCaching(amount, Math.Rounding.Up), amount);
        return true;
    }
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        _approveElastic(owner, spender, _allowanceWithCaching(owner, spender) + addedValue);
        return true;
    }
