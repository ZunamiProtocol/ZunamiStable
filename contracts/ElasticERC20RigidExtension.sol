...
abstract contract ElasticERC20RigidExtension is ElasticERC20 {
    ...
    function containRigidAddress(address _rigidAddress) public virtual view returns(bool);
    ...
    returns (bool)
    {
        ...
        require(currentAllowance >= subtractedValue, "RigidElasticERC20: decreased allowance below zero");
        unchecked {
