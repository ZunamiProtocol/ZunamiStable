...
function shouldBehaveLikeRigidERC20(
    errorPrefix,
    initialSupply,
    initialHolder,
    recipient,
        ...
        describe('when the token owner is not the zero address', function () {
            ...
            describe('when the recipient is not the zero address', function () {
                ...
                describe('when the spender does not have enough allowance', function () {
                    const allowance = mulNorm(initialSupply, assetPrice).subn(1);
...
function shouldBehaveLikeRigidERC20Transfer(
    errorPrefix,
    from,
    to,
    balance,
...
function shouldBehaveLikeRigidERC20Approve(
    errorPrefix,
    owner,
    spender,
    supply,
